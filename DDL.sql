...
declare
    ...
    pay number;
begin
    SELECT MIN_WAGE, EROLE INTO min_salary, emp_role FROM SERVICE_CENTER S, EMPLOYEES E WHERE S.SCID=:new.SCID AND E.EMPID=:new.EMPID AND E.SCID=:new.SCID AND E.EROLE = 'MECHANIC';
